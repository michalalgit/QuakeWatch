...
# Running the Application with Docker (Containerized Version)

This project is fully containerized using Docker and can be built and run locally without installing Python dependencies manually.
...
docker run --rm -p 5000:5000 quakewatch:local
...
docker pull michalreuven/quakewatch:1.0  
docker run --rm -p 5000:5000 michalreuven/quakewatch:1.0
...
michalreuven/quakewatch:1.0

This image can be pulled and executed on any machine with Docker installed.
